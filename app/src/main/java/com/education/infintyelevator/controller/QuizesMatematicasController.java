...
import com.education.infintyelevator.view.QuizMatematica;
...
public class QuizesMatematicasController extends QuizesController {
        ...
        public QuizesMatematicasController(FragmentQuizMatematicaBinding binding) {
            ...
            quizesLista.add(new Quizes("Um retângulo tem base medindo 8 cm e altura 5 cm. Qual sua área?", R.id.radioButtonBMatematica, "26 cm²", "40 cm²", "32 cm²", "20 cm²"));
